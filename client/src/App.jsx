...
import AdminLayout from './pages/admin/AdminLayout'; // Mantendo a navegação para o painel
import AdminDashboard from './pages/admin/Dashboard'; // Importando o Dashboard
      ...
      <div className="min-h-screen bg-neutral-900 text-white p-6">
        ...
        <Routes>
          ...
          <Route path="/admin" element={<AdminLayout />}>
            {/* Aqui, você renderiza o Dashboard dentro do AdminLayout */}
            <Route index element={<AdminDashboard />} />
            {/* Outras rotas dentro do painel */}
          </Route>
        </Routes>
      </div>
    </BrowserRouter>
