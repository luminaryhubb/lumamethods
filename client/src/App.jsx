...
export default function App(){
  ...
  useEffect(()=>{ fetch('/api/me').then(r=>r.json()).then(d=>{ if(d.logged) setMe(d) }) },[])
  return (
      ...
      <div className="container">
        <header className="flex items-center justify-between py-4">
          ...
          <nav className="flex gap-2">
            ...
            <Link to="/create-fake" className="px-3 py-1 rounded text-white bg-neutral-800">Link Fake</Link>
        ...
        <main>
          <Routes>
            ...
            <Route path="/create-fake" element={<CreateFake/>} />
