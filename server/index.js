...
// DISCORD_CLIENT_ID, DISCORD_CLIENT_SECRET, DISCORD_CALLBACK_URL, SESSION_SECRET
...
if (!fs.existsSync(CONFIG_FILE)) fs.writeFileSync(CONFIG_FILE, JSON.stringify({ siteName:'Luma Methods - Best Methods', logo:'https://media.discordapp.net/attachments/1414311428218814606/1420127903265460364/standard_10.gif', themeColor:'#7c3aed', allowCreation:true, shortenerUrl:'' }, null, 2));
...
app.get('/auth/discord/callback', passport.authenticate('discord', { failureRedirect: '/' }), (req, res) => {
  res.redirect('/'); // frontend will call /api/me to populate state
});
...
// /api/me returns profile + user record
...
app.get('/l/:id', (req,res) => {
  ...
  links.links[id] = l;
  writeJSON(LINKS_FILE, links);
  res.json({ id:l.id, output:l.output, owner:l.owner, network:l.network, views:l.views });
});
